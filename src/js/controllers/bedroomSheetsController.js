angular.module('app').controller('bedroomSheetsController',bedroomSheetsController)
function bedroomSheetsController($scope,$window,dataService,$state){
...
bedroomSheetsController.$inject=['$scope','$window','dataService','$state']