angular.module('app').controller('kitchenSheetsController',kitchenSheetsController)
function kitchenSheetsController($scope,$state,dataService,$window){
...
kitchenSheetsController.$inject=['$scope','$state','dataService','$window']